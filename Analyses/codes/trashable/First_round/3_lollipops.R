...

{
    ...
    Iron_deprivation_effect_at_Exp=read.table("Outputs_def/Stats_tables/txt/Iron_deprivation_effect_at_Exp.txt")
    Iron_deprivation_effect_at_Stat=read.table("Outputs_def/Stats_tables/txt/Iron_deprivation_effect_at_Stat.txt")
    Stat_effect_with_Fe=read.table("Outputs_def/Stats_tables/txt/Stat_effect_with_Fe.txt")
    Stat_effect_without_Fe=read.table("Outputs_def/Stats_tables/txt/Stat_effect_without_Fe.txt")
    Stat_Fedeprivation_interaction=read.table("Outputs_def/Stats_tables/txt/Stat_Fedeprivation_interaction.txt")
...

{
    ...
    pdf("Outputs_def/Figures/flipping_genes_stat_FCs.pdf",width=7,height=8)
    print(flip_plot_ok)
    dev.off()
...

{
    ...
    pdf("Outputs_def/Figures/mycobactins_Fe_deprivation_FCs.pdf",width=5,height=6)
    print(mbt_plot)
    dev.off()
    ## It will require manual tinkering.
...
{
    with=read.delim("Outputs_def/fgsea/Tuberculist/SEWFe/fgsea_output_tables/SEWFe.txt")[,1:7]
    wout=read.delim("Outputs_def/fgsea/Tuberculist/SEWOFe/fgsea_output_tables/SEWOFe.txt")[,1:7]
    ...
    pdf("Outputs_def/Figures/tuberculist_fgsea.pdf",width=7,height=4)
    print(pl_tub)
    dev.off()
...

{
    ...
    dir.create(paste0("Outputs_def/Figures/lollipop_plot_genesets/",name),recursive=TRUE)
    write.table(local,paste0("Outputs_def/Figures/lollipop_plot_genesets/",name,"/stats.txt"))
    
    pdf(paste0("Outputs_def/Figures/lollipop_plot_genesets/",name,"/plot.pdf"),width=8,height=nrow(local)*slope_vs+intercept)
    print(flip_plot_ok)
    dev.off()
...
dir.create("Outputs_def/Figures/sup_lollipops/",recursive=TRUE)
pdf("Outputs_def/Figures/sup_lollipops/metals.pdf",height=20,width=14)
print(pl_metales)
dev.off()
...
dir.create("Outputs_def/Figures/sup_lollipops/",recursive=TRUE)
pdf("Outputs_def/Figures/sup_lollipops/RNAs_TAs.pdf",height=15,width=7)
print(pl_RNAs_TAs)
dev.off()
...
dir.create("Outputs_def/Figures/sup_lollipops/",recursive=TRUE)
pdf("Outputs_def/Figures/sup_lollipops/TCA.pdf",height=20,width=21)
print(pl_TCA)
dev.off()
...
dir.create("Outputs_def/Figures/sup_lollipops/",recursive=TRUE)
pdf("Outputs_def/Figures/sup_lollipops/oxphos.pdf",height=20,width=14)
print(pl_oxphos)
dev.off()
